...
db.users.insertOne({
  ...
  created_at: new Date(),
  last_login: new Date(),
  password_hash: '\$2b\$12\$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X3.YMfZIBHF5Vq2hy'
});
...
curl -X GET "https://your-app.com/api/modules" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test admin analytics
curl -X GET "https://your-app.com/api/admin/analytics" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
db.modules.find().limit(2).pretty();
"
